...
class XSVFDecoder(object):
    ...
    def decode_xsdrinc(self):
        ...
        while n:
            self.xsdrinc_data_list.append(self.get_next_bytes(self.length2_bytes))
            n -= 1
        return True
    ...
    def decode_xtrst(self):
        # TODO not handling this (programmer doesn't either) - just skip arg
        self.get_next_byte()
        return True
    ...
    _instruction_data = (
        ...
        (
            "<invalid>",
            handle_invalid,
        ),  # TODO should probably be some other instruction...
        (
            "<invalid>",
            handle_invalid,
        ),  # TODO should probably be some other instruction...
