...
byte_sequence_list = byte_sequence + pp.ZeroOrMore(
    comma + optional_asm_comment + byte_sequence
)
...
xtdomask = pp.Group(pp.Keyword("XTDOMASK") + optional_asm_comment + byte_sequence)
xsir = pp.Group(
    pp.Keyword("XSIR")
    + optional_asm_comment
    + integer
    + optional_asm_comment
    + byte_sequence
)
...
xcomment = pp.Group(pp.Keyword("XCOMMENT") + optional_asm_comment + xcomment_argument)
xwait = pp.Group(
    pp.Keyword("XWAIT")
    + optional_asm_comment
    + state
